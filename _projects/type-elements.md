...
**Print these for yourself, freely.** That's the point of the project. These machines are a century old, the parts stopped being manufactured decades ago, and a typewriter sitting idle for want of a typewheel is the problem all of this exists to solve. Every model on this page is generated by [an open pipeline](https://github.com/dairyking98/Type-Elements) that anyone can download and run — no permission needed, no fee. Print a wheel for your Blickensderfer, a shuttle for your Hammond, a set for someone in your restoration club. Giving prints away is fine too, as long as no money changes hands.

**Selling prints is the one thing reserved.** If you want to sell them, [get in touch](https://instagram.com/blick_elements) — the answer isn't automatically no, and it's the same conversation as a custom commission.

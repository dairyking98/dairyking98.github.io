...
Save as /assets/img/2026/typewriters/hammond-model-1-15058/specimen.jpg, then uncomment:
...
<!-- DISCUSSION: add a section per topic worth writing about — restoration,
     ...
     {% include figure image_path="/assets/img/2026/typewriters/hammond-model-1-15058/<name>.jpg" alt="" caption="" %}

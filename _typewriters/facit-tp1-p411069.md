...
# header:
#   image: /assets/img/2026/typewriters/facit-tp1-p411069/main.jpg
#   teaser: /assets/img/2026/typewriters/facit-tp1-p411069/main.jpg
...
# gallery:
#   - url: /assets/img/2026/typewriters/facit-tp1-p411069/gallery-01.jpg
#     image_path: /assets/img/2026/typewriters/facit-tp1-p411069/gallery-01.jpg
#     alt: ""
#   - url: /assets/img/2026/typewriters/facit-tp1-p411069/gallery-02.jpg
#     image_path: /assets/img/2026/typewriters/facit-tp1-p411069/gallery-02.jpg
#     alt: ""
---
...
{% include gallery caption="Facit TP1, serial P411069." %}
-->

## Type specimen

<!-- Full alphabet, digits, punctuation, on white paper.
Save as /assets/img/2026/typewriters/facit-tp1-p411069/specimen.jpg, then uncomment:
{% include figure image_path="/assets/img/2026/typewriters/facit-tp1-p411069/specimen.jpg" alt="Type specimen from the Facit TP1" caption="Typed on P411069." %}
-->
...
<!-- DISCUSSION: add a section per topic worth writing about — restoration,
     ...
     {% include figure image_path="/assets/img/2026/typewriters/facit-tp1-p411069/<name>.jpg" alt="" caption="" %}

...
# header:
#   image: /assets/img/2026/typewriters/harris-visible-no-4-19149/main.jpg
#   teaser: /assets/img/2026/typewriters/harris-visible-no-4-19149/main.jpg
...
# gallery:
#   - url: /assets/img/2026/typewriters/harris-visible-no-4-19149/gallery-01.jpg
#     image_path: /assets/img/2026/typewriters/harris-visible-no-4-19149/gallery-01.jpg
#     alt: ""
#   - url: /assets/img/2026/typewriters/harris-visible-no-4-19149/gallery-02.jpg
#     image_path: /assets/img/2026/typewriters/harris-visible-no-4-19149/gallery-02.jpg
#     alt: ""
---
...
{% include gallery caption="Harris Visible no. 4, serial 19149." %}
-->

## Type specimen

<!-- Full alphabet, digits, punctuation, on white paper.
Save as /assets/img/2026/typewriters/harris-visible-no-4-19149/specimen.jpg, then uncomment:
{% include figure image_path="/assets/img/2026/typewriters/harris-visible-no-4-19149/specimen.jpg" alt="Type specimen from the Harris Visible no. 4" caption="Typed on 19149." %}
-->
...
<!-- DISCUSSION: add a section per topic worth writing about — restoration,
     ...
     {% include figure image_path="/assets/img/2026/typewriters/harris-visible-no-4-19149/<name>.jpg" alt="" caption="" %}
